              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: Colors.grey.withOpacity(0.8), spreadRadius: 3, blurRadius: 5)],
                    // )
                  ),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          boxShadow: [BoxShadow(color: Colors.orange.withOpacity(0.3), spreadRadius: 1, offset: const Offset(0, 1), blurRadius: 10)],
                          color:Colors.white,
                            ...
                            TextField(
                              keyboardType:TextInputType.phone,
                                ...
                                decoration: InputDecoration(
                                  ...
                                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10), borderSide:  BorderSide(color: Colors.black87)),
